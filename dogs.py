...
#   copying a list of items innto another list, and changing the data in the list.

dogs = ["Sadie", "Molly", "MIlo", "Buddy", "Rocky", "Annabelle", "Gonzo", "Sweetie-Pie", "Diego"]
dogs2 = []
...
def main():
    ...
    print ("Pop a dogoff position 3 (Which is the 4th dog) in the list:")
    print (dogs)
