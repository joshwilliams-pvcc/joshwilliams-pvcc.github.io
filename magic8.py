...
#   Prog Purpose: This Magic 8-ball code uses a Python tuplt since the user does not have the ability to change the 8-Ball answers.
#   However, the program could have used a Python list instead of a tuple
# NOTE: Tuples use parenthese; lists use square braces

import random
answers_8_ball = ("AS I see is, yes", "Ask again later",
    ...
    "Without a doubt", "Yes", 
    "Yes definately", "You may rely on it", )
...
def main():
    ...
    while another_question:
        ...
        askAgain = input("\nWhat would you like to ask me another question (Y or N)?:")
        if askAgain.upper() == "N" or askAgain == "n":
            another_question = False

    print("\nCome bask agian when you have other important questions.")
    print("... MAGIC-8Ball OUT.")
